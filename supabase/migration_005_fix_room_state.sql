-- ============================================================
-- Correctif : get_room_state renvoyait NULL (page "Ma salle"
-- bloquée sur "Chargement…") quand l'utilisateur n'avait encore
-- jamais déclenché la création de sa ligne user_progression
-- (aucune séance terminée, aucun clic sur les outils de debug).
...
declare
  v_result json;
begin
  -- Crée la ligne de progression par défaut si elle n'existe pas encore
  -- (même logique que dans add_xp_and_check_levelup / debug_add_xp).
